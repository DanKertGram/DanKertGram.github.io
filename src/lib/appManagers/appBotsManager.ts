...
import {DanKertGramWebViewSendEventMap} from '@types';
...
export default class AppBotsManager extends AppManager {
  ...
  public async writeBotDeviceStorage(botId: BotId, key: string, value: string | null): Promise<DanKertGramWebViewSendEventMap['device_storage_failed']['error'] | null> {
