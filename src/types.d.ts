...
export type DanKertGramWebViewTheme = {
  bg_color: string,
 ...
 */
export type DanKertGramWebViewEventMap = {
  iframe_ready: {
  ...
  web_app_switch_inline_query: {
    chat_types?: DanKertGramChoosePeerType[],
    query: string
  },
...
export type DanKertGramWebViewSerializedEvent<T extends keyof DanKertGramWebViewEventMap> = {
  eventType: T,
  eventData: DanKertGramWebViewEventMap[T]
};

export type DanKertGramWebViewSerializedEvents = {
  [type in keyof DanKertGramWebViewEventMap]: DanKertGramWebViewSerializedEvent<type>
};

export type DanKertGramWebViewEvent = DanKertGramWebViewSerializedEvents[keyof DanKertGramWebViewEventMap];
export type DanKertGramWebViewEventCallback = (event: DanKertGramWebViewEvent) => void;

export type DanKertGramWebViewSendEventMap = {
  ...
  theme_changed: {
    theme_params: DanKertGramWebViewTheme
  },
  popup_closed: {
    button_id?: string
  },
...
// export type DanKertGramWebViewSendSerializedEvent<T extends keyof DanKertGramWebViewSendEventMap> = {
//   eventType: T,
//   eventData: DanKertGramWebViewSendEventMap[T]
// };

// export type DanKertGramWebViewSendSerializedEvents = {
//   [type in keyof DanKertGramWebViewSendEventMap]: DanKertGramWebViewSendSerializedEvent<type>
// };

// export type DanKertGramWebViewSendEvent = DanKertGramWebViewSerializedEvents[keyof DanKertGramWebViewSendEventMap];
// export type DanKertGramWebViewSendEventCallback = (event: DanKertGramWebViewSendEvent) => void;
