...
import {changeBrightness, getRgbColorFromDanKertGramColor, rgbaToHexa, rgbIntToHex} from '@helpers/color';
...
function StarGiftGridItem(props: {
  ...
  return (
    <div
      ...
      style={{
        '--overlay-color': rgbaToHexa(changeBrightness(getRgbColorFromDanKertGramColor(props.item.collectibleAttributes?.backdrop?.edge_color ?? 0), 0.9))
      }}
