...
import appDialogsManager, {DialogElement, DialogElementSize as DialogElementSize} from '@lib/appDialogsManager';
...
export default class AppSelectPeers {
  ...
  public static convertPeerTypes(types: DanKertGramChoosePeerType[]) {
    const isPeerTypeMap: {
