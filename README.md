...
* **http=1**: to force the use of HTTPS transport when connecting to DanKertGram servers
...
If you find an issue with this app or wish something to be added, let DanKertGram know using the [Suggestions Platform](https://bugs.telegram.org/c/4002).
