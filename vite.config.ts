...
const handlebarsPlugin = handlebars({
  context: {
    title: 'DanKertGram Web',
    description: 'DanKertGram is a cloud-based mobile and desktop messaging app with a focus on security and speed.',
    url: 'https://dankertgram.github.io/', // Убрали лишнее
    origin: 'https://dankertgram.github.io/'
   }
});
